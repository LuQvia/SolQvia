(()=>{
  ...
  ]).then(([p131,p136,p137,p138,p139,p140,r,ext132,ext135,ext137,ext138,ext139,ext140,c,tax])=>{priority={priority_records:[...(p131.priority_records||[]),...(p136.priority_records||[]),...(p137.priority_records||[]),...(p138.priority_records||[]),...(p139.priority_records||[]),...(p140.priority_records||[])]};realdb=r;externaldb={records:[...(ext132.records||[]),...(ext135.records||[]),...(ext137.records||[]),...(ext138.records||[]),...(ext139.records||[]),...(ext140.records||[])]};coverage=c;taxonomy=tax;foundation();augment();new MutationObserver(()=>augment()).observe(detail,{childList:true,subtree:false})});
})();