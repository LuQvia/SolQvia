(()=>{
  ...
  fetch('/assets/data/phase171-mnp-reservation-deep-master-v1.json').then(r=>r.json()).then(db=>{
    ...
    for(const root of roots){
      ...
      root.innerHTML='<div class="p171-head"><div><p class="eyebrow">Phase171 · MNP Reservation Deep Master</p><h2>予約番号・ワンストップ手続き診断</h2><p>72サービスを統一形式で確認。最新再検証済みサービスは2026年9月23日公式再確認済み、残りは旧確認日を保持します。</p></div><span>72 services</span></div>'+
